...
<body>
	<div class="topnav">
	<a href="#" class="active">Add Customers</a>
			...
			<div class="table-wrapper">
				...
				<div class="clearfix">
					...
					<ul class="pagination">
						...
						<li class="page-item"><a href="#" class="page-link">Report Daily Sales</a></li>
					</ul>
				</div>
			</div>
		</div>        
...
<form >
					...
					<form action="payment.php" method="post">
						...
						<label>
							<input type="radio" name="radio" value="credit">credit
						</label>
						
						<div class="mb-3"> <input type="submit" name="Submit" value="Add" class="btn btn-success" vlaue="Get Values">
						</div>
