...
<style>
	...
	.table-wrapper {
        ...
        padding: 20px 25px;
		border-radius: 3px;
        box-shadow: 0 1px 1px rgba(37, 13, 222, 0.05);
    }
	.table-title {        
		padding-bottom: 15px;
		background: #04068d;
...
<body>
	...
	<a href="login.html">Logout</a>
        <a href="Add customer.html">Manage customer</a>
			...
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						...
						<div class="col-xs-6">
							<a href="#addcustomerModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Add New Medicine</span></a>
